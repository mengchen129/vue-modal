...
new Vue({
    ...
    methods: {
        myAlert: function() {
            this.alert('您已经升级为VIP会员', '系统提示');
        },
        myAlertLongText: function() {
            this.alert('热烈欢迎产品经理张小明加入芝麻一家亲！张小明毕业于南昌大学，软件工程专业出身，曾经在搜狐等一线互联网公司任职，工作经验非常丰富，是即做过产品的攻城师，又是做过技术的产品！希望大家多多交流，共同学习进步！', '欢迎新同学');
        },
        myAlertNoTitle: function() {
            this.alert('今天天气真好,适合出去跑步玩耍', '');
        },
        myConfirm: function() {
            this.confirm('确定清空购物车么?', '确认', function(ok) {
                alert(ok);
            });
        },
